...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioResponse> actualizarCuenta(HttpServletRequest request,@RequestBody ActualizarUsuarioRequest actualizarUsuario) throws NoExisteException, DuplicadoException {
