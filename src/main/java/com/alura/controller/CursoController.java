...
public class CursoController {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<CursoResponse> modificarCurso(@PathVariable Long idCurso,@RequestBody @Valid ModificarCursoRequest modificarCurso) throws NoExisteException {
    ...
    public ResponseEntity<Page<CursoResponse>> listadoCursosPorCategoria(@PathVariable Long idCategoria, @PageableDefault(size = 10) Pageable paginacion) throws NoExisteException {
